...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Footer_nav_vue__ = __webpack_require__(14);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_b722b9e8_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Footer_nav_vue__ = __webpack_require__(55);
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Footer_nav_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_b722b9e8_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Footer_nav_vue__["a" /* default */],
...
module.exports = __webpack_require__.p + "book.png?4252276542d1a91f3af4073e7dce273a";

/***/ }),
/* 6 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "cart.png?535db136e6373e29bd9b6fe8ff6c69ed";

/***/ }),
/* 7 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "doorder.png?1600eee0cbd1aa95d94a6c9b037e90c7";
...
module.exports = __webpack_require__.p + "1.jpg?14966c83f358432b25cb5574d855149f";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_css_global_scss__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_css_global_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__assets_css_global_scss__);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_config_js__ = __webpack_require__(3);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      num: '1人',
      mark: '',
      api: __WEBPACK_IMPORTED_MODULE_0__model_config_js__["a" /* default */].api,
      uid: __WEBPACK_IMPORTED_MODULE_0__model_config_js__["a" /* default */].storage.get('uid'),
      userList: [],
      showloading: true
    };
  },
  methods: {
    peopleInfoList: function peopleInfoList() {
      var _this = this;
    ...
    choose: function choose() {
      //选择人数
      var that = this;
      var arrs = document.querySelectorAll('.content span');
      for (var i = 0; i < arrs.length; i++) {
        arrs[i].onclick = function () {
          ...
          that.num = this.innerHTML.trim(); //trim()去空格          
        };
      }
      var arrs1 = document.querySelectorAll('.mark span');
      for (var i = 0; i < arrs1.length; i++) {
        arrs1[i].onclick = function () {
          for (var j = 0; j < arrs1.length; j++) {
            arrs1[j].className = '';
          }
          this.className = 'active';
          that.mark = this.innerHTML.trim(); //trim()去空格          
        };
      }
    },
  ...
  mounted: function mounted() {
    ...
    if (uid) {
      __WEBPACK_IMPORTED_MODULE_0__model_config_js__["a" /* default */].storage.set('uid', uid);
    }
...
module.exports = __webpack_require__.p + "canju.png?e72a0c63bac59fc13d7936d743aa2e28";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__public_Footer_nav_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__public_Footer_cart_vue__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__model_config_js__ = __webpack_require__(3);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      api: __WEBPACK_IMPORTED_MODULE_2__model_config_js__["a" /* default */].api,
      list: []
    };
  },
  methods: {
    loadData: function loadData() {
      ...
      this.$http.get(api).then(function (response) {
        // console.log(response);
        _this.list = response.body.result;
      });
    },

    //菜单定位
    changeList: function changeList(key) {
      var itemCatesDom = document.querySelectorAll(".list_title");
    ...
    this.loadData();
    var side_cate = document.getElementById('side_cate');
    var nav_cate = document.getElementById('nav_cate');
    var bg = document.getElementById('bg');
    var state = true;
    nav_cate.onclick = bg.onclick = function () {
      if (state) {
        state = false;
        side_cate.style.transform = 'translate(0,0)';
        bg.style.display = 'block';
      } else {
        state = true;
        side_cate.style.transform = 'translate(-100%,0)';
        bg.style.display = 'none';
      }
    };
  },
  components: {
    'footer_nav': __WEBPACK_IMPORTED_MODULE_0__public_Footer_nav_vue__["a" /* default */],
    'footer_cart': __WEBPACK_IMPORTED_MODULE_1__public_Footer_cart_vue__["a" /* default */]
  }
});
...
module.exports = __webpack_require__.p + "close.png?e41a09d2885f7db750744e56daf24bd5";
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    sockets: {
        ...
        load: function load() {
            ...
            var api = this.api + "api/cartCount?uid=" + this.uid;
            this.$http.get(api).then(function (response) {
                // console.log(response);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    load: function load() {
      ...
      this.$http.get(api).then(function (response) {
        console.log(response);
        _this.list = response.body.result[0];
        _this.num = _this.list.num;
      });
    },
    decNum: function decNum() {
      if (this.num > 1) {
        --this.num;
      }
    },
    ...
    addCart: function addCart() {
      ...
      this.$http.post(api, {
        ...
        product_id: this.list.cate_id,
        img_url: this.list.img_url,
        price: this.list.price,
        num: this.num
      }).then(function (response) {
        if (response) {
          _this2.$socket.emit('addcart', 'addcart'); //加入购物车时给服务器发消息
          _this2.$router.push('/home');
        }
      }, function (err) {
        console.log(err);
...
module.exports = __webpack_require__.p + "2.jpg?2948b7b2737eee8f6ed504d859df7915";

/***/ }),
/* 20 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "3.jpg?8267cbdacd0ef0d1ea0245b2c87a757f";

/***/ }),
/* 21 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "4.jpg?e2629faf3873bee02a336468553aadea";

/***/ }),
/* 22 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "5.jpg?b54329511f4f6ffd9794bef6853e77a5";

/***/ }),
/* 23 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "6.jpg?1c2a877e4852d589aee69c1373db1f4f";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__public_Footer_nav_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__model_config_js__ = __webpack_require__(3);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      api: __WEBPACK_IMPORTED_MODULE_1__model_config_js__["a" /* default */].api,
      list: '',
      uid: __WEBPACK_IMPORTED_MODULE_1__model_config_js__["a" /* default */].storage.get('uid'),
      peopleinfo: '',
      allPrice: '',
      totalNum: ''
    };
  ...
  sockets: {
    ...
    decNum: function decNum(item, key) {
      var _this2 = this;

      var api = this.api + 'api/decCart?uid=' + this.uid + '&product_id=' + item.product_id + '&num=' + item.num;
      this.$http.get(api).then(function (response) {
        console.log(response);
        _this2.getTotalResult();
      }, function (err) {
        console.log(err);
      });
      if (item.num == 1) {
        ...
        this.$socket.emit('addcart', 'addcart'); //加入购物车时给服务器发消息
        --item.num;
      }
    },
    incNum: function incNum(item) {
      var _this3 = this;

      var api = this.api + 'api/incCart?uid=' + this.uid + '&product_id=' + item.product_id + '&num=' + item.num;
      this.$http.get(api).then(function (response) {
        console.log(response);
        _this3.getTotalResult();
      }, function (err) {
        console.log(err);
      });
      this.$socket.emit('addcart', 'addcart'); //加入购物车时给服务器发消息
    ...
    peopleInfoList: function peopleInfoList() {
      ...
      var api = this.api + 'api/peopleInfoList?uid=' + this.uid;
      this.$http.get(api).then(function (response) {
        _this4.peopleinfo = response.body.result[0];
      }, function (err) {
        console.log(err);
      });
    },
    getTotalResult: function getTotalResult() {
      ...
      this.allPrice = parseFloat(allPrice);
      this.totalNum = parseFloat(totalNum);
    },
    addOrder: function addOrder() {
      ...
      this.$http.post(api, {
        ...
        // console.log(response);
        if (response.body.success) {
          _this5.$socket.emit('addcart', 'addcart'); //给服务器发消息
          _this5.$router.push('/order1');
        }
      }, function (err) {
        console.log(err);
      });
    ...
    methods: {
        getOrder: function getOrder() {
            ...
            this.$http.get(api).then(function (response) {
                console.log(response);
                _this.list = response.body.result[0];
                var time = new Date(_this.list.add_time);
                console.log(time);
        ...
        doWeixinPay: function doWeixinPay() {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    peopleInfoList: function peopleInfoList() {
      ...
      var api = this.api + 'api/peopleInfoList?uid=' + this.uid;
      this.$http.get(api).then(function (response) {
        _this.peopleinfo = response.body.result[0];
        _this.num = _this.peopleinfo.p_num;
        _this.mark = _this.peopleinfo.p_mark;
      }, function (err) {
        console.log(err);
      });
    },
    ...
    save: function save() {
      ...
      this.$http.post(api, {
        ...
        if (response.body.success) {
          _this2.$socket.emit('addcart', 'addcart'); //给服务器发消息
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_resource__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_config_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_socket_io__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_socket_io___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_vue_socket_io__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Start_vue__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Home_vue__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Pcontent_vue__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Hot_vue__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Search_vue__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Cart_vue__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_Order1_vue__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_Order2_vue__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_EditInfo_vue__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Success_vue__ = __webpack_require__(98);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(new __WEBPACK_IMPORTED_MODULE_5_vue_socket_io___default.a({
  connection: 'http://a.itying.com?roomid=' + __WEBPACK_IMPORTED_MODULE_4__model_config_js__["a" /* default */].storage.get('uid')
}));
...
var routes = [{ path: '/start', component: __WEBPACK_IMPORTED_MODULE_6__components_Start_vue__["a" /* default */] }, { path: '/home', component: __WEBPACK_IMPORTED_MODULE_7__components_Home_vue__["a" /* default */] }, { path: '/pcontent', component: __WEBPACK_IMPORTED_MODULE_8__components_Pcontent_vue__["a" /* default */] }, { path: '/hot', component: __WEBPACK_IMPORTED_MODULE_9__components_Hot_vue__["a" /* default */] }, { path: '/search', component: __WEBPACK_IMPORTED_MODULE_10__components_Search_vue__["a" /* default */] }, { path: '/cart', component: __WEBPACK_IMPORTED_MODULE_11__components_Cart_vue__["a" /* default */] }, { path: '/order1', component: __WEBPACK_IMPORTED_MODULE_12__components_Order1_vue__["a" /* default */] }, { path: '/order2', component: __WEBPACK_IMPORTED_MODULE_13__components_Order2_vue__["a" /* default */] }, { path: '/editinfo', component: __WEBPACK_IMPORTED_MODULE_14__components_EditInfo_vue__["a" /* default */] }, { path: '/success', component: __WEBPACK_IMPORTED_MODULE_15__components_Success_vue__["a" /* default */] }, { path: '*', redirect: '/start' }];
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(8), __webpack_require__(32).setImmediate))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(10);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_2855407a_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(41);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_2855407a_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var update = __webpack_require__(1)("2e48904c", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("285c3346", content, true, {});
...
// module
exports.push([module.i, "blockquote,body,button,caption,dd,div,dl,dt,fieldset,figure,form,h1,h2,h3,h4,h5,h6,hr,html,input,legend,li,menu,ol,p,pre,table,td,textarea,th,ul{margin:0;padding:0}address,article,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section{display:block}table{border-collapse:collapse;border-spacing:0}caption,th{text-align:left;font-weight:400}html{font-size:10px}abbr,body,fieldset,html,iframe,img{border:0}address,cite,dfn,em,i,var{font-style:normal}[hidefocus],summary{outline:0}li{list-style:none}h1,h2,h3,h4,h5,h6,small{font-size:100%}sub,sup{font-size:83%}code,kbd,pre,samp{font-family:inherit}q:after,q:before{content:none}textarea{overflow:auto;resize:none}label,summary{cursor:default}a,button{cursor:pointer}b,em,h1,h2,h3,h4,h5,h6,strong{font-weight:700}a,a:hover,del,ins,s,u{text-decoration:none}body,button,input,keygen,legend,select,textarea{font:1rem/1.5 arial,Microsoft YaHei,\\5b8b\\4f53,sans-serif;color:#666;outline:0}body{background:#f2f2f2}input{position:relative}input[type=password],input[type=text],select,textarea{padding:.8rem .4rem;border:1px solid #aaa;-moz-border-radius:.3rem;-webkit-border-radius:.3rem;border-radius:.3rem;vertical-align:middle}textarea{height:auto;line-height:20px;vertical-align:top}select{height:30px}a,a:hover{color:#666}a{-webkit-transition:all .5s;-moz-transition:all .5s;-ms-transition:all .5s;-o-transition:all .5s;transition:all .5s}img{max-width:100%}.m-lif2:after,.m-lif3:after,.m-lif4:after,.m-lif5:after,.m-lif6:after,.m-lif7:after,.m-lif8:after,.m-lif9:after,.m-lif10:after{display:block;clear:both;visibility:hidden;height:0;overflow:hidden;content:\".\"}.m-lif2,.m-lif3,.m-lif4,.m-lif5,.m-lif6,.m-lif7,.m-lif8,.m-lif9,.m-lif10{zoom:1}.m-lif2>li,.m-lif3>li,.m-lif4>li,.m-lif5>li,.m-lif6>li,.m-lif7>li,.m-lif8>li,.m-lif9>li,.m-lif10>li{float:left}.m-lif2>li{width:49.98%}.m-lif3>li{width:33.31%}.m-lif4>li{width:24.99%}.m-lif5>li{width:20%}.m-lif6>li{width:16.65%}.m-lif7>li{width:14.28%}.m-lif8>li{width:12.48%}.m-lif9>li{width:11.11%}.m-lif10>li{width:9.98%}.m-nav,.m-nav li,.m-nav li a{height:50px;line-height:50px}.m-nav{text-align:center;background:#fead1f}.m-nav li,.m-nav li a{display:inline-block;*display:inline;*zoom:1;position:relative;float:left;width:150px}.m-nav li.z-crt,.m-nav li:hover{background:#ffba57}.m-nav li a{font-size:18px;color:#fff;text-decoration:none}.m-nav .dropdown{display:none;position:absolute;left:0;top:50px;width:150px;background:#fead1f;z-index:99;-moz-box-shadow:1px 1px 3px #666;-webkit-box-shadow:1px 1px 3px #666;box-shadow:1px 1px 3px #666}.m-nav .dropdown a{border-top:1px solid #ff9703}.m-nav .dropdown a:hover{background:#ffba57}.m-slide{position:relative;width:100%;height:320px;overflow:hidden}.m-slide li,.m-slide ol{position:absolute;top:0;left:0;width:100%;height:100%;z-index:20}.m-slide ol{width:1920px;left:50%;margin-left:-960px}.m-hd{padding:1px 0 0}.m-hd>.ti{height:40px;line-height:40px;margin-bottom:-1px}.m-hd>.ti>a{display:inline-block;float:left;height:38px;line-height:38px;margin-right:5px;padding:0 40px;border:1px solid #ccc;text-align:center;color:#333;font-size:14px;text-decoration:none;background:#f8f8f8;-moz-border-radius:5px 5px 0 0;-webkit-border-radius:5px 5px 0 0;border-radius:5px 5px 0 0}.m-hd>.ti>.z-crt{border-bottom:1px solid #fff;background:#fff}.m-hd>.ct{display:none;padding:20px;border:1px solid #ccc}.m-hd>.z-crt{display:block}.m-hd1>.ti{height:30px;line-height:30px;padding:0 10px;margin-bottom:-1px;font-size:14px;border:1px solid #ccc;cursor:pointer;background-color:#f2f2f2}.m-hd1>.ti.z-crt{background-color:#fff}.m-hd1>.ct{display:none;padding:10px;margin-bottom:-1px;border:1px solid #ccc}.m-table{width:100%}.m-table td,.m-table th{padding:10px;border:1px solid #ddd}.m-table th{font-weight:700}.m-table tbody tr:hover{background:#f0f0f0}.m-table .even{background:#f9f9f9}.m-success{width:160px;margin-left:auto;margin-right:auto}.u-pointer{position:absolute;bottom:10px;left:50%;width:1250px;margin-left:-625px;text-align:center;z-index:50;line-height:0}.u-pointer i{display:inline-block;*display:inline;*zoom:1;width:30px;height:3px;overflow:hidden;margin:0 5px;cursor:pointer;background:#fff}.u-pointer i.z-crt,.u-pointer i:hover{background:#fea01a}.u-pointer1{position:absolute;bottom:13px;right:15px;z-index:50;text-align:center;line-height:0}.u-pointer1 i{display:inline-block;*display:inline;*zoom:1;width:10px;height:10px;overflow:hidden;margin:0 0 0 10px;border-radius:50%;box-shadow:inset 0 1px 0 rgba(0,0,0,.5);cursor:pointer;background:#a4a19f}.u-pointer1 i.z-crt,.u-pointer1 i:hover{background:#a35d0a}.u-next,.u-prev{display:none;position:absolute;top:125px;left:20px;width:50px;height:70px;background:url(/static_dzpay/pc/img/v1/page/arrow.png) no-repeat 0 0;filter:alpha(opacity=20);-moz-opacity:.2;-khtml-opacity:.2;opacity:.2;cursor:pointer;z-index:99}.u-next:hover,.u-prev:hover{filter:alpha(opacity=60);-moz-opacity:.5;-khtml-opacity:.5;opacity:.5}.u-next{left:auto;right:20px;background-position:0 -70px}.u-btn{display:inline-block;*display:inline;*zoom:1;*overflow:visible;-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;padding:0 12px;line-height:28px;border:1px solid #2d88bf;border-radius:5px;font-size:12px;letter-spacing:1px;word-spacing:normal;text-align:center;vertical-align:middle;cursor:pointer;box-shadow:inset 0 1px 0 hsla(0,0%,100%,.5);text-shadow:0 -1px rgba(0,0,0,.2);background:#54aede}button.u-btn,input.u-btn{*line-height:25px}.u-btn,.u-btn:hover{color:#fff;text-decoration:none}.u-btn:focus,.u-btn:hover{background:#399dd8}.u-btn:active{box-shadow:inset 0 1px 4px rgba(0,0,0,.2)}.u-btn::-moz-focus-inner{padding:0;margin:0;border:0}.u-btn-c1{border-color:#9f161b;background:#de2027}.u-btn-c1:focus,.u-btn-c1:hover{background:#cc1c23}.u-btn-c2{border-color:#e1962d;background:#faa42b}.u-btn-c2:focus,.u-btn-c2:hover{background:#f8960a}.u-btn-c3{border-color:#52a552;background:#5cbc5c}.u-btn-c3:focus,.u-btn-c3:hover{background:#50b150}.u-btn-c4{border-color:#d0d0d0;text-shadow:0 1px hsla(0,0%,100%,.8);background:#f3f3f3}.u-btn-c4,.u-btn-c4:hover{color:#333}.u-btn-c4:focus,.u-btn-c4:hover{background:#e7e7e7}.u-t{display:inline-block;*display:inline;*zoom:1;width:0;height:0;overflow:hidden;vertical-align:middle;border-style:solid;border-width:4px 4px 0;border-color:#000 transparent transparent}.u-t1{border-width:0 4px 4px;border-color:transparent transparent #000}.u-success{width:32px;height:32px;padding:14px;background:green;border-radius:50%}.f-left-5{position:relative;left:-5px}.f-cb:after,.f-cbli li:after{display:block;clear:both;visibility:hidden;height:0;overflow:hidden;content:\".\"}.f-cb,.f-cbli li,.f-ib{zoom:1}.f-ib{display:inline-block;*display:inline}.f-dn{display:none}.f-mlra{margin-left:auto;margin-right:auto}.f-db{display:block}.f-fl{float:left}.f-fr{float:right}.f-pr,.f-prz{position:relative}.f-prz{zoom:1}.f-oh{overflow:hidden}.f-ff0{font-family:\\5b8b\\4f53}.f-ff1{font-family:Microsoft YaHei,\\5fae\\8f6f\\96c5\\9ed1,arial,\\5b8b\\4f53}.f-fsi{font-style:italic}.f-fs12{font-size:1.2rem}.f-fs14{font-size:1.4rem}.f-fs16{font-size:1.6rem}.f-fs18{font-size:1.8rem}.f-fs20{font-size:2rem}.f-fs22{font-size:2.2rem}.f-fs24{font-size:2.4rem}.f-fs26{font-size:2.6rem}.f-fs28{font-size:2.8rem}.f-fs30{font-size:3rem}.f-fwn{font-weight:400}.f-fwb{font-weight:700}.f-tal{text-align:left}.f-tac{text-align:center}.f-tar{text-align:right}.f-taj{text-align:justify;text-justify:inter-ideograph}.f-vam,.f-vama *{vertical-align:middle}.f-wsn{word-wrap:normal;white-space:nowrap}.f-pre{overflow:hidden;text-align:left;white-space:pre-wrap}.f-pre,.f-wwb{word-wrap:break-word;word-break:break-all}.f-wwb{white-space:normal}.f-ti{overflow:hidden;text-indent:-30000px}.f-ti2,.f-ti2p p{text-indent:2em}.f-ls2{letter-spacing:2px}.f-ls5{letter-spacing:5px}.f-lhn{line-height:normal}.f-lh1{line-height:1.15rem}.f-lh1d5{line-height:1.5rem}.f-lh2{line-height:2rem}.f-lh3{line-height:3rem}.f-lh4{line-height:4rem}.f-cr,.f-cr:hover,.f-cr a{color:red}.f-cg,.f-cg:hover,.f-cg a{color:green}.f-cf,.f-cf:hover,.f-cf a{color:#fff}.f-cc,.f-cc:hover,.f-cc a{color:#ccc}.f-c0,.f-c0 a,.f-c0:hover{color:#000}.f-c3,.f-c3 a,.f-c3:hover{color:#333}.f-c6,.f-c6 a,.f-c6:hover{color:#666}.f-c9,.f-c9 a,.f-c9:hover{color:#999}.f-tdl,.f-tdl:hover{text-decoration:line-through}.f-tdu,.f-tdu:hover{text-decoration:underline}.f-tdn,.f-tdn:hover{text-decoration:none}.f-toe{overflow:hidden;word-wrap:normal;white-space:nowrap;text-overflow:ellipsis}.f-csp{cursor:pointer}.f-csd{cursor:default}.f-csh{cursor:help}.f-csm{cursor:move}.f-usn{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;-o-user-select:none;user-select:none}.f-wa{width:auto}.f-w1{width:100%}.f-wb2{width:20%}.f-wb3{width:30%}.f-wb4{width:40%}.f-wb6{width:60%}.f-wb8{width:80%}.f-wb9{width:90%}.f-mw1{max-width:100%}.f-w5{width:.5rem}.f-w10{width:1rem}.f-w15{width:1.5rem}.f-w20{width:2rem}.f-w25{width:2.5rem}.f-w30{width:3rem}.f-w35{width:3.5rem}.f-w40{width:4rem}.f-w50{width:5rem}.f-w60{width:6rem}.f-w70{width:7rem}.f-w80{width:8rem}.f-w90{width:9rem}.f-mb5{margin-bottom:.5rem}.f-mb10{margin-bottom:1rem}.f-mb15{margin-bottom:1.5rem}.f-mb20{margin-bottom:2rem}.f-mb30{margin-bottom:3rem}.f-mb40{margin-bottom:4rem}.f-mb50{margin-bottom:5rem}.f-mr5{margin-right:.5rem}.f-mr10{margin-right:1rem}.f-mr15{margin-right:1.5rem}.f-mr20{margin-right:2rem}.f-mr30{margin-right:3rem}.f-mr40{margin-right:4rem}.f-mr50{margin-right:5rem}.f-ml5{margin-left:.5rem}.f-ml10{margin-left:1rem}.f-ml15{margin-left:1.5rem}.f-ml20{margin-left:2rem}.f-ml30{margin-left:3rem}.f-ml40{margin-left:4rem}.f-ml50{margin-left:5rem}.f-ml60{margin-left:6rem}.f-ml70{margin-left:7rem}.f-ml80{margin-left:8rem}.f-ml90{margin-left:9rem}.f-ml100{margin-left:10rem}.f-mlr5{margin-left:.5rem;margin-right:.5rem}.f-mlr10{margin-left:1rem;margin-right:1rem}.f-mlr15{margin-left:1.5rem;margin-right:1.5rem}.f-mlr20{margin-left:2rem;margin-right:2rem}.f-mlr30{margin-left:3rem;margin-right:3rem}.f-pt5{padding-top:.5rem}.f-pt10{padding-top:1rem}.f-pt15{padding-top:1.5rem}.f-pt20{padding-top:2rem}.f-pt25{padding-top:2.5rem}.f-pt30{padding-top:3rem}.f-pt35{padding-top:3.5rem}.f-pt40{padding-top:4rem}.f-pt50{padding-top:5rem}.f-pr5{padding-right:.5rem}.f-pr10{padding-right:1rem}.f-pr15{padding-right:1.5rem}.f-pr20{padding-right:2rem}.f-pr30{padding-right:3rem}.f-pr40{padding-right:4rem}.f-pr50{padding-right:5rem}.f-pb5{padding-bottom:.5rem}.f-pb10{padding-bottom:1rem}.f-pb15{padding-bottom:1.5rem}.f-pb20{padding-bottom:2rem}.f-pb30{padding-bottom:3rem}.f-pb40{padding-bottom:4rem}.f-pb50{padding-bottom:5rem}.f-pl5{padding-left:.5rem}.f-pl10{padding-left:10rem}.f-pl15{padding-left:15rem}.f-pl20{padding-left:20rem}.f-pl30{padding-left:30rem}.f-pl40{padding-left:40rem}.f-pl50{padding-left:50rem}.f-p5{padding:.5rem}.f-p10{padding:1rem}.f-p15{padding:1.5rem}.f-p20{padding:2rem}.f-ptb5{padding-top:.5rem;padding-bottom:.5rem}.f-ptb10{padding-top:1rem;padding-bottom:1rem}.f-ptb15{padding-top:1.5rem;padding-bottom:1.5rem}.f-ptb20{padding-top:2rem;padding-bottom:2rem}.f-ptb30{padding-top:3rem;padding-bottom:3rem}.f-ptb40{padding-top:4rem;padding-bottom:4rem}.f-ptb50{padding-top:5rem;padding-bottom:5rem}.f-plr5{padding-left:.5rem;padding-right:.5rem}.f-plr10{padding-left:1rem;padding-right:1rem}.f-plr15{padding-left:1.5rem;padding-right:1.5rem}.f-plr20{padding-left:2rem;padding-right:2rem}.f-plr30{padding-left:3rem;padding-right:3rem}.f-plr40{padding-left:4rem;padding-right:4rem}.f-plr50{padding-left:5rem;padding-right:5rem}.f-b1{border:1px solid #dcdcdc}.f-bt1{border-top:1px solid #dcdcdc}.f-br1{border-right:1px solid #dcdcdc}.f-br1d{border-right:1px dashed #dcdcdc}.f-bb1{border-bottom:1px solid #dcdcdc}.f-bb1d{border-bottom:1px dashed #dcdcdc}.f-bl1{border-left:1px solid #dcdcdc}.f-b1f{border:1px solid #fff}.f-b1r{border:1px solid red}.f-bgf{background:#fff}.f-ts1{text-shadow:1px 1px 2px #666}.f-bdr{-moz-border-radius:50%;-webkit-border-radius:50%;border-radius:50%}.f-bdr5{-moz-border-radius:.5rem;-webkit-border-radius:.5rem;border-radius:.5rem}.f-bdr10{-moz-border-radius:1rem;-webkit-border-radius:1rem;border-radius:1rem}.f-bdr15{-moz-border-radius:1.5rem;-webkit-border-radius:1.5rem;border-radius:1.5rem}.f-bdr20{-moz-border-radius:2rem;-webkit-border-radius:2rem;border-radius:2rem}.f-bs10{-moz-box-shadow:0 0 10px #000;-webkit-box-shadow:0 0 10px #000;box-shadow:0 0 10px #000}@media screen and (min-width:319px){html{font-size:10px}}@media screen and (min-width:359px){html{font-size:12px}}@media screen and (min-width:414px){html{font-size:14px}}@media screen and (min-width:479px){html{font-size:16px}}@media screen and (min-width:539px){html{font-size:18px}}@media screen and (min-width:639px){html{font-size:20px}}@media screen and (min-width:959px){html{font-size:30px}}.footer_book,.footer_cart,.footer_nav{position:fixed;bottom:.5rem;width:5rem;height:4.2rem;padding-top:.8rem;line-height:1.2em;text-align:center;color:#fff;border-radius:50%}.footer_book img,.footer_cart img,.footer_nav img{width:2rem}.footer_nav{left:.5rem}.footer_book,.footer_nav{background:rgba(0,0,0,.8)}.footer_book{left:50%;margin-left:-2.5rem}.footer_cart{right:.5rem;background:rgba(255,0,0,.8)}.footer_cart .tip{position:absolute;top:0;right:0;width:1.5rem;height:1.5rem;line-height:1.5rem;text-align:center;background:rgba(255,0,0,.8);border-radius:50%}.footer_nav_show{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.6);z-index:5}.footer_nav_show li{position:fixed;width:5rem;height:4.2rem;padding-top:.8rem;line-height:1.2em;text-align:center;color:#fff;border-radius:50%;background:rgba(0,0,0,.8)}.footer_nav_show li img{width:2rem}.footer_nav_show li:first-child{bottom:12rem;left:.5rem}.footer_nav_show li:nth-child(2){bottom:10rem;left:6rem}.footer_nav_show li:nth-child(3){bottom:6rem;left:10rem}.footer_nav_show li:nth-child(4){bottom:.5rem;left:12rem}.footer_nav_show li:nth-child(5){bottom:.5rem;left:.5rem}.footer_nav_show li a{color:#fff}.m-scrool1{overflow:hidden}.m-scrool1 ul{overflow-x:scroll;white-space:nowrap}.m-scrool1 ul li{display:inline-block;overflow:hidden}.u-btn1{display:block;height:3rem;line-height:3rem;padding:0 1rem;color:#fff;background:red;border-radius:.5rem}.u-numinput .jia,.u-numinput .jian{float:left;width:2.6rem;height:3.1rem;line-height:3.1rem;border:1px solid #aaa;font-size:2rem;color:red;text-align:center}.u-numinput input{float:left;width:2rem;border-radius:0;border-left:none;border-right:none;text-align:center}", ""]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Start_vue__ = __webpack_require__(11);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_65c34642_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Start_vue__ = __webpack_require__(49);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Start_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_65c34642_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Start_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("787b0daa", content, true, {});
...
// module
exports.push([module.i, ".start_content{padding-top:5rem}.start_content .start_head{width:15rem;margin:0 auto 1rem;height:3rem;line-height:3rem;font-size:1.4rem;color:#fff;text-align:center;background:#000}.start_content .start_head img{height:2rem;vertical-align:middle}.start_content .text{margin-bottom:2rem}.start_content .content ul,.start_content .mark{display:flex;flex-wrap:wrap;padding:0 .5rem}.start_content .content ul li,.start_content .mark li{width:25%;padding:.5rem;box-sizing:border-box}.start_content .content ul li span,.start_content .mark li span{display:block;line-height:3rem;text-align:center;border:1px solid #999;background-color:#fff;border-radius:.5rem}.start_content .content ul .active,.start_content .mark .active{color:#fff;border:none;background-color:red}.start_content .start{position:fixed;bottom:5rem;left:50%;width:6rem;height:5rem;padding-top:1rem;margin-left:-3rem;font-size:1.4rem;text-align:center;color:#fff;background:red;border-radius:50%}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showloading),expression:"showloading"}]},[_vm._v("\n      加载中。。。\n    ")]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.showloading),expression:"!showloading"}],staticClass:"start_content"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"f-tac f-cr text"},[_vm._v("请选择正确的用餐人数 ，小二马上给你送餐具")]),_vm._v(" "),_c('div',{staticClass:"content f-mb30"},[_c('ul',_vm._l((_vm.userList),function(item,key){return _c('li',[_c('span',{class:{'active':key==0}},[_vm._v(_vm._s(item))])])}))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.mark),expression:"mark"}],staticClass:"f-wb9 f-db f-lh2 f-mlra f-mb10",attrs:{"type":"text","placeholder":"备注信息"},domProps:{"value":(_vm.mark)},on:{"input":function($event){if($event.target.composing){ return; }_vm.mark=$event.target.value}}}),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('div',{staticClass:"start",on:{"click":function($event){_vm.start()}}},[_vm._v("开始"),_c('br'),_vm._v("点餐")])])])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"start_head"},[_c('img',{attrs:{"src":__webpack_require__(12)}}),_vm._v(" 用餐人数\n\t\t\t")])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"mark"},[_c('li',[_c('span',[_vm._v("不辣")])]),_vm._v(" "),_c('li',[_c('span',[_vm._v("微辣")])]),_vm._v(" "),_c('li',[_c('span',[_vm._v("中辣")])]),_vm._v(" "),_c('li',[_c('span',[_vm._v("重辣")])])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Home_vue__ = __webpack_require__(13);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_2439bdec_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Home_vue__ = __webpack_require__(63);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Home_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_2439bdec_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Home_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("77131a6c", content, true, {});
...
// module
exports.push([module.i, ".index{padding:.5rem}.index .header ul{display:flex;flex-wrap:wrap;margin-bottom:1rem;border-radius:.5rem;background:#fff}.index .header ul li{flex:1;padding:.5rem 0;border-right:1px solid #f1f1f1;text-align:center}.index .header ul li img{width:1.6rem}.index .header ul li:last-child{border-right:none}.index .list_title{font-size:1.2rem;font-weight:700;text-align:center;line-height:1.8rem}.index .list ul{display:flex;flex-wrap:wrap;margin-bottom:.5rem}.index .list ul li{width:33.32%;padding:.5rem;box-sizing:border-box}.index .list ul li .inner{border-radius:.5rem;overflow:hidden;background:#fff}.index .list ul li .inner p{padding-left:.5rem}.index .list ul li .inner .title{font-weight:700}.index .list ul li .inner .price{font-size:.8rem}.index .list ul li .inner img{width:100%;color:#fff}.side_cate{position:fixed;top:0;left:0;width:6rem;height:100%;padding-left:.5rem;background:#e7e7e7;transition:all .5s;transform:translate(-100%);z-index:3}.side_cate li{line-height:3rem}.side_cate .nav_cate{position:absolute;top:45%;left:6.5rem;width:3rem;height:4rem;padding-right:.5rem;text-align:center;border-radius:0 50% 50% 0;background:hsla(0,2%,51%,.9)}.side_cate .nav_cate img{width:2rem;margin-top:.5rem}.side_cate .nav_cate p{margin-top:-.5rem;color:#fff}.bg{display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.5)}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("0177f794", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(!_vm.flag)?_c('div',{staticClass:"footer_nav",attrs:{"id":"footer_nav"},on:{"click":function($event){_vm.flag=!_vm.flag}}},[_c('img',{attrs:{"src":__webpack_require__(56),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("导航")])]):_vm._e(),_vm._v(" "),(_vm.flag)?_c('div',{staticClass:"footer_nav_show",attrs:{"id":"footer_nav_show"}},[_c('ul',[_c('li',[_c('router-link',{attrs:{"to":"/home"}},[_c('img',{attrs:{"src":__webpack_require__(5),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("菜单")])])],1),_vm._v(" "),_c('li',[_c('router-link',{attrs:{"to":"/cart"}},[_c('img',{attrs:{"src":__webpack_require__(6),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("购物车")])])],1),_vm._v(" "),_c('li',[_c('router-link',{attrs:{"to":"/order1"}},[_c('img',{attrs:{"src":__webpack_require__(57),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("我的订单")])])],1),_vm._v(" "),_c('li',[_c('router-link',{attrs:{"to":"/order2"}},[_c('img',{attrs:{"src":__webpack_require__(58),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("结账")])])],1),_vm._v(" "),_c('li',{attrs:{"id":"back"},on:{"click":function($event){_vm.flag=!_vm.flag}}},[_c('img',{attrs:{"src":__webpack_require__(15),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("关闭")])])])]):_vm._e()])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
module.exports = __webpack_require__.p + "navigation.png?642ffd43cbd922b10392a15f0fbe0fb4";

/***/ }),
/* 57 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "order.png?db12ccabb6336e2c027a6888630202f8";

/***/ }),
/* 58 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "wallet.png?e3e750e9dfe8f694f5ef98f111db20ea";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Footer_cart_vue__ = __webpack_require__(16);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_3d28ac60_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Footer_cart_vue__ = __webpack_require__(62);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Footer_cart_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_3d28ac60_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Footer_cart_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("461f054c", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('router-link',{attrs:{"to":"/cart"}},[_c('div',{staticClass:"footer_cart"},[_c('img',{attrs:{"src":__webpack_require__(6),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("购物车")]),_vm._v(" "),(_vm.data.result)?_c('div',{staticClass:"tip"},[_vm._v(_vm._s(_vm.data.result))]):_vm._e()])])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"index"},[_c('div',{staticClass:"header"},[_c('ul',[_c('li',[_c('router-link',{attrs:{"to":"/hot"}},[_c('img',{attrs:{"src":__webpack_require__(64)}}),_c('br'),_vm._v("热销榜")])],1),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('li',[_c('router-link',{attrs:{"to":"/search"}},[_c('img',{attrs:{"src":__webpack_require__(65)}}),_c('br'),_vm._v("搜你喜欢")])],1)])]),_vm._v(" "),_vm._l((_vm.list),function(item){return _c('div',[_c('div',{staticClass:"list_title"},[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('div',{staticClass:"list"},[_c('ul',_vm._l((item.list),function(i){return _c('li',[_c('div',{staticClass:"inner"},[_c('router-link',{attrs:{"to":'/pcontent?id='+i._id}},[_c('img',{attrs:{"src":_vm.api+i.img_url}}),_vm._v(" "),_c('p',{staticClass:"title"},[_vm._v(_vm._s(i.title))]),_vm._v(" "),_c('p',{staticClass:"price"},[_vm._v("¥"+_vm._s(i.price))])])],1)])}))])])})],2),_vm._v(" "),_c('div',{staticClass:"side_cate",attrs:{"id":"side_cate"}},[_c('ul',_vm._l((_vm.list),function(item,key){return _c('li',{on:{"click":function($event){_vm.changeList(key)}}},[_vm._v(_vm._s(item.title))])})),_vm._v(" "),_vm._m(1)]),_vm._v(" "),_c('div',{staticClass:"bg",attrs:{"id":"bg"}}),_vm._v(" "),_c('footer_nav'),_vm._v(" "),_c('footer_cart')],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',[_c('img',{attrs:{"src":__webpack_require__(66)}}),_c('br'),_vm._v("点过的菜\n\t\t\t\t\t")])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"nav_cate",attrs:{"id":"nav_cate"}},[_c('img',{attrs:{"src":__webpack_require__(67)}}),_vm._v(" "),_c('p',[_vm._v("菜单")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
module.exports = __webpack_require__.p + "rexiao.png?ba3e02c7778c3d15f0540fc7de4f5c55";

/***/ }),
/* 65 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "sousuo.png?31ac29ecc5f690239c5e8249f2bd347a";

/***/ }),
/* 66 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "caidan.png?cff648fe9a2a461373e79d5f8b8bb396";

/***/ }),
/* 67 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "nav.png?c1614724343e0f5ad7affe45d9c43b4f";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Pcontent_vue__ = __webpack_require__(17);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_08c4d202_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Pcontent_vue__ = __webpack_require__(71);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Pcontent_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_08c4d202_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Pcontent_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("d9cbdac2", content, true, {});
...
// module
exports.push([module.i, ".pcontent{padding-bottom:5rem}.pcontent .bottom{position:fixed;left:0;bottom:0;width:100%;height:5rem;padding:1rem .5rem;border-top:1px solid #ccc;text-align:center;background:#fff;box-sizing:border-box}.pcontent .back{position:fixed;top:.5rem;left:.5rem;width:4rem;height:4rem;line-height:4rem;font-size:1.2rem;color:#fff;text-indent:1.2rem;background:rgba(0,0,0,.6);border-radius:50%}.pcontent .back:before{content:\"\";display:block;position:absolute;top:1.5rem;left:.4rem;width:.8rem;height:.8rem;border-left:.2rem solid #fff;border-bottom:.2rem solid #fff;transform:rotate(45deg)}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"pcontent"},[_c('div',{staticClass:"back",on:{"click":function($event){_vm.back()}}},[_vm._v("返回")]),_vm._v(" "),_c('div',{staticClass:"f-bgf f-mb10"},[_c('img',{staticClass:"f-w1",attrs:{"src":_vm.api+_vm.list.img_url,"alt":""}}),_vm._v(" "),_c('div',{staticClass:"f-p5"},[_c('p',{staticClass:"f-fs14 f-fwb"},[_vm._v(_vm._s(_vm.list.title))]),_vm._v(" "),_c('p',{staticClass:"f-cr"},[_vm._v(_vm._s(_vm.list.price)+"/份")])])]),_vm._v(" "),_c('div',{staticClass:"f-bgf f-p10"},[_c('p',{staticClass:"f-fs12 f-fwb f-mb5"},[_vm._v("商品详情")]),_vm._v(" "),_c('div',{domProps:{"innerHTML":_vm._s(_vm.list.content)}})]),_vm._v(" "),_c('div',{staticClass:"bottom f-cb"},[_c('div',{staticClass:"f-fl"},[_c('div',{staticClass:"f-fl f-lh3 f-fs12"},[_vm._v("\n                  数量：\n              ")]),_vm._v(" "),_c('div',{staticClass:"u-numinput f-ib"},[_c('div',{staticClass:"jian",on:{"click":function($event){_vm.decNum()}}},[_vm._v("-")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.num),expression:"num"}],attrs:{"type":"text"},domProps:{"value":(_vm.num)},on:{"input":function($event){if($event.target.composing){ return; }_vm.num=$event.target.value}}}),_vm._v(" "),_c('div',{staticClass:"jia",on:{"click":function($event){++_vm.num}}},[_vm._v("+")])])]),_vm._v(" "),_c('div',{staticClass:"f-fr"},[_c('div',{staticClass:"u-btn1 f-fs12",on:{"click":function($event){_vm.addCart()}}},[_vm._v("加入购物车")])])])])])}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Hot_vue__ = __webpack_require__(18);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_0826045e_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Hot_vue__ = __webpack_require__(75);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Hot_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_0826045e_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Hot_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("faa4f488", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"f-ptb20 f-tac f-fs16 f-fwb"},[_vm._v("本店热销榜")]),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('footer_nav'),_vm._v(" "),_vm._m(1),_vm._v(" "),_vm._m(2)],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"f-plr5 f-bgf f-mb50"},[_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(9),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(19),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(20),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(21),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(22),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(23),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"footer_book",attrs:{"id":"footer_nav"}},[_c('img',{attrs:{"src":__webpack_require__(5),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("菜单")])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"footer_cart"},[_c('img',{attrs:{"src":__webpack_require__(6),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("购物车")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Search_vue__ = __webpack_require__(24);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_b1f5c8de_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Search_vue__ = __webpack_require__(79);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_b1f5c8de_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Search_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("22d98368", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_vm._m(0),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('footer_nav'),_vm._v(" "),_vm._m(2),_vm._v(" "),_vm._m(3)],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"f-p10 f-tac"},[_c('input',{staticClass:"f-wb8",attrs:{"type":"text"}})])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"f-plr5 f-bgf f-mb50"},[_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(9),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(19),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(20),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(21),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(22),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])]),_vm._v(" "),_c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr10",attrs:{"src":__webpack_require__(23),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")]),_vm._v(" "),_c('p',[_vm._v("已售：351份")])])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"footer_book",attrs:{"id":"footer_nav"}},[_c('img',{attrs:{"src":__webpack_require__(5),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("菜单")])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"footer_cart"},[_c('img',{attrs:{"src":__webpack_require__(6),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("购物车")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Cart_vue__ = __webpack_require__(25);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_78fdf93f_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Cart_vue__ = __webpack_require__(83);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Cart_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_78fdf93f_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Cart_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("edb0ce6e", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"f-p10"},[(_vm.totalNum)?_c('div',[_c('div',{staticClass:"f-p5 f-bgf f-mb10 f-bdr5"},[_c('div',{staticClass:"f-fs16 f-fwb f-bb1 f-ptb5 f-tac"},[_vm._v("购物车")]),_vm._v(" "),_c('div',{staticClass:"f-ptb10 f-bb1"},[_c('div',{staticClass:"f-fr f-lh1"},[_c('router-link',{attrs:{"to":"/editinfo"}},[_c('img',{staticClass:"f-w20",attrs:{"src":__webpack_require__(84),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("修改")])])],1),_vm._v(" "),_c('p',{staticClass:"f-cr"},[_vm._v("用餐人数："+_vm._s(_vm.peopleinfo.p_num))]),_vm._v(" "),_c('p',[_vm._v("备注："+_vm._s(_vm.peopleinfo.p_mark))])]),_vm._v(" "),_c('div',{staticClass:"f-pt10 f-bb1"},[_c('p',[_vm._v("购物车中共有"+_vm._s(_vm.totalNum)+"个菜")]),_vm._v(" "),_c('p',[_vm._v("合计："),_c('span',{staticClass:"f-fs20 f-cr"},[_vm._v("￥"+_vm._s(_vm.allPrice))])])])]),_vm._v(" "),_c('ul',{staticClass:"f-p5 f-bgf f-bdr5 f-mb10"},_vm._l((_vm.list),function(item,key){return _c('li',{staticClass:"f-ptb10 f-bb1 f-cb"},[_c('div',{staticClass:"u-numinput f-fr"},[_c('div',{staticClass:"jian",on:{"click":function($event){_vm.decNum(item,key)}}},[_vm._v("-")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(item.num),expression:"item.num"}],attrs:{"type":"text"},domProps:{"value":(item.num)},on:{"change":function($event){_vm.getTotalResult();},"input":function($event){if($event.target.composing){ return; }_vm.$set(item, "num", $event.target.value)}}}),_vm._v(" "),_c('div',{staticClass:"jia",on:{"click":function($event){_vm.incNum(item)}}},[_vm._v("+")])]),_vm._v(" "),_c('img',{staticClass:"f-fl f-w40 f-mr5 f-bdr5",attrs:{"src":_vm.api+item.img_url,"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs12 f-fwb"},[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('p',[_vm._v("￥"+_vm._s(item.price))])])}))]):_vm._e(),_vm._v(" "),_vm._m(0),_vm._v(" "),(!_vm.totalNum)?_c('div',{staticClass:"f-pt50 f-tac"},[_vm._v("您的购物车空空的，点击菜单开始点菜")]):_vm._e()]),_vm._v(" "),_c('footer_nav'),_vm._v(" "),_c('div',{staticClass:"footer_book",attrs:{"id":"footer_nav"},on:{"click":function($event){_vm.$router.push('/home')}}},[_c('img',{attrs:{"src":__webpack_require__(5),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("菜单")])]),_vm._v(" "),_c('div',{staticClass:"footer_cart",on:{"click":function($event){_vm.addOrder()}}},[_c('img',{attrs:{"src":__webpack_require__(7),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("下单")])])],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"f-bgf f-p5 f-bdr5"},[_c('div',{staticClass:"f-fs12 f-fwb f-mb5"},[_vm._v("本店顾客最长点的菜")]),_vm._v(" "),_c('div',{staticClass:"m-scrool1"},[_c('ul',[_c('li',{staticClass:"f-w80 f-mr5"},[_c('img',{staticClass:"f-w1 f-bdr5",attrs:{"src":__webpack_require__(9),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("大蒜腊肉")]),_vm._v(" "),_c('p',[_vm._v("￥26")])])])])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
module.exports = __webpack_require__.p + "edit.png?65fb866c70d74abd39c273f4799b2351";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Order1_vue__ = __webpack_require__(26);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_690b957d_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Order1_vue__ = __webpack_require__(88);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Order1_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_690b957d_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Order1_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("57db65e8", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"f-p10"},[_c('div',{staticClass:"f-p10 f-bgf f-bdr5 f-mb10"},[_c('div',{staticClass:"f-cb"},[_c('img',{staticClass:"f-fl f-w50 f-mr5",attrs:{"src":__webpack_require__(89),"alt":""}}),_vm._v(" "),_c('p',{staticClass:"f-fs16 f-fwb f-pt5 f-mb5"},[_vm._v(_vm._s(_vm.uid)+"号桌待门店接单")]),_vm._v(" "),_c('p',[_vm._v("请及时联系服务员确认点单信息！")])]),_vm._v(" "),_c('div',{staticClass:"f-fs14 f-fwb"},[_vm._v("已点菜品"+_vm._s(_vm.list.total_num)+"份，合计："),_c('span',{staticClass:"f-fs20 f-cr"},[_vm._v(_vm._s(_vm.list.total_price)+"元")])])]),_vm._v(" "),_c('div',{staticClass:"f-bgf f-bdr5"},[_c('div',{staticClass:"f-p5 f-fs12 f-fwb f-bb1"},[_vm._v("菜品详情：")]),_vm._v(" "),_c('ul',{staticClass:"f-p10 f-lh2"},_vm._l((_vm.list.items),function(item){return _c('li',{staticClass:"f-cb"},[_c('div',{staticClass:"f-wb6 f-fl"},[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('div',{staticClass:"f-wb2 f-fl"},[_vm._v(_vm._s(item.num)+"份")]),_vm._v(" "),_c('div',[_vm._v(_vm._s(item.price)+"元")])])}))])]),_vm._v(" "),_c('footer_nav'),_vm._v(" "),_c('div',{staticClass:"footer_cart",on:{"click":function($event){_vm.$router.push('/order2')}}},[_c('img',{attrs:{"src":__webpack_require__(7),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("结账")])])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
module.exports = __webpack_require__.p + "timer.png?2d2cf256cb2683e8b5fb70992fb81e6d";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Order2_vue__ = __webpack_require__(27);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_341ea3c7_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Order2_vue__ = __webpack_require__(93);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Order2_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_341ea3c7_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Order2_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("205167a7", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"f-p10"},[_c('div',{staticClass:"f-bgf f-bdr5 f-mb10"},[_c('div',{staticClass:"f-p10 f-bb1"},[_c('div',{staticClass:"f-fs16 f-fwb f-tac f-ptb10 f-mb5"},[_vm._v("已下单的菜")]),_vm._v(" "),_c('ul',{staticClass:"f-cb"},[_c('div',{staticClass:"f-wb3 f-fl"},[_vm._v("桌号："+_vm._s(_vm.uid))]),_vm._v(" "),_c('div',{staticClass:"f-wb3 f-fl"},[_vm._v("人数："+_vm._s(_vm.list.p_num))]),_vm._v(" "),_c('div',[_vm._v("下单时间："+_vm._s(_vm.time))])])]),_vm._v(" "),_c('div',{staticClass:"f-ptb10 f-plr5 f-lh3"},[_vm._v("\n              应付金额："),_c('span',{staticClass:"f-fs16 f-fwb f-cr"},[_vm._v("￥"+_vm._s(_vm.list.total_price))])])]),_vm._v(" "),_c('div',{staticClass:"f-p20 f-bgf f-bdr5 f-mb10"},[_c('span',{staticClass:"u-btn f-mr10",on:{"click":function($event){_vm.doPay()}}},[_vm._v("支付宝支付")]),_vm._v(" "),_c('span',{staticClass:"u-btn u-btn-c3",on:{"click":function($event){_vm.doWeixinPay()}}},[_vm._v("微信支付")])]),_vm._v(" "),_c('div',{staticClass:"f-bgf f-bdr5"},[_c('div',{staticClass:"f-p5 f-fs12 f-fwb f-bb1"},[_vm._v("菜品详情：")]),_vm._v(" "),_c('ul',{staticClass:"f-p10 f-lh2"},_vm._l((_vm.list.items),function(item){return _c('li',{staticClass:"f-cb"},[_c('div',{staticClass:"f-wb6 f-fl"},[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('div',{staticClass:"f-wb2 f-fl"},[_vm._v(_vm._s(item.num)+"份")]),_vm._v(" "),_c('div',[_vm._v(_vm._s(item.price)+"元")])])}))])]),_vm._v(" "),_c('footer_nav')],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_EditInfo_vue__ = __webpack_require__(28);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_f2d8d69a_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_EditInfo_vue__ = __webpack_require__(97);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_EditInfo_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_f2d8d69a_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_EditInfo_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("61ce936e", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_c('div',{staticClass:"start_content"},[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"f-tac f-cr text"},[_vm._v("请选择正确的用餐人数 ，小二马上给你送餐具")]),_vm._v(" "),_c('div',{staticClass:"content f-mb30"},[_c('ul',_vm._l((_vm.userList),function(item,key){return _c('li',[_c('span',{class:{'active':parseInt(_vm.peopleinfo.p_num)==key+1}},[_vm._v(_vm._s(item))])])}))]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.mark),expression:"mark"}],staticClass:"f-wb9 f-db f-lh2 f-mlra f-mb10",attrs:{"type":"text","placeholder":"备注信息"},domProps:{"value":(_vm.mark)},on:{"input":function($event){if($event.target.composing){ return; }_vm.mark=$event.target.value}}}),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('div',{staticClass:"footer_nav",on:{"click":function($event){_vm.$router.go(-1)}}},[_c('img',{attrs:{"src":__webpack_require__(15),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("返回")])]),_vm._v(" "),_c('div',{staticClass:"footer_cart",on:{"click":function($event){_vm.save()}}},[_c('img',{attrs:{"src":__webpack_require__(7),"alt":""}}),_vm._v(" "),_c('p',[_vm._v("保存")])])])])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"start_head"},[_c('img',{attrs:{"src":__webpack_require__(12)}}),_vm._v(" 修改用餐人数\n\t\t\t")])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"mark"},[_c('li',[_c('span',[_vm._v("不辣")])]),_vm._v(" "),_c('li',[_c('span',[_vm._v("微辣")])]),_vm._v(" "),_c('li',[_c('span',[_vm._v("中辣")])]),_vm._v(" "),_c('li',[_c('span',[_vm._v("重辣")])])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Success_vue__ = __webpack_require__(29);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_231d7848_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Success_vue__ = __webpack_require__(101);
function injectStyle (ssrContext) {
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_Success_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_231d7848_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_Success_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("a3c667d6", content, true, {});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":""}},[_vm._m(0),_vm._v(" "),_c('footer_nav')],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"f-p10"},[_c('div',{staticClass:"f-bgf f-bdr5 f-mb10"},[_c('div',{staticClass:"m-success f-cb f-ptb30"},[_c('div',{staticClass:"u-success f-fl f-mr10"},[_c('img',{attrs:{"src":__webpack_require__(7),"width":"32","alt":""}})]),_vm._v(" "),_c('div',{staticClass:"f-fs16 f-fwb f-pt10"},[_vm._v("支付成功")]),_vm._v("\n              期待您再次光临\n          ")])]),_vm._v(" "),_c('div',{staticClass:"f-bgf f-bdr5"},[_c('div',{staticClass:"f-p5 f-fs12 f-fwb f-bb1"},[_vm._v("订单详情：")]),_vm._v(" "),_c('ul',{staticClass:"f-p10 f-lh2"},[_c('li',[_c('span',{staticClass:"f-fr"},[_vm._v("已完成")]),_vm._v("订单状态")]),_vm._v(" "),_c('li',[_c('span',{staticClass:"f-fr"},[_vm._v("a001")]),_vm._v("桌号")]),_vm._v(" "),_c('li',[_c('span',{staticClass:"f-fr"},[_vm._v("12")]),_vm._v("人数")]),_vm._v(" "),_c('li',[_c('span',{staticClass:"f-fr"},[_vm._v("121412123123")]),_vm._v("订单号")]),_vm._v(" "),_c('li',[_c('span',{staticClass:"f-fr"},[_vm._v("2018-04-15")]),_vm._v("结账时间")]),_vm._v(" "),_c('li',[_c('span',{staticClass:"f-fr"},[_vm._v("￥79")]),_vm._v("支付金额")])])])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
